    ...
    case "meta":
      return (
        <svg viewBox="0 0 28 28" width={s} height={s}>
          <rect width="28" height="28" rx="6" fill="#0082FB"/>
          <path
            d="M6 17.5c0 1.5.3 2.6.8 3.3.5.7 1.2 1 2 1 .9 0 1.7-.4 2.6-1.5.7-.9 1.5-2.3 2.1-3.8l.9-2.3c.8-2 1.8-3.5 2.8-4.4.9-.8 1.9-1.3 3-1.3 1.7 0 3.1 1 4.1 2.8.9 1.7 1.3 3.8 1.3 5.8 0 1.3-.3 2.4-.7 3.2h-2.5c.5-.9.8-2 .8-3.3 0-1.7-.3-3.2-.9-4.3-.5-.9-1.2-1.4-2-1.4-.9 0-1.7.6-2.5 1.8-.5.7-1 1.7-1.5 2.9l-.4 1c-.9 2.2-1.6 3.6-2.4 4.5-1 1.1-2.1 1.7-3.4 1.7-1.7 0-3.1-.8-4-2.3C6.4 20.4 6 18.8 6 17.5z"
            fill="white"
          />
          <path
            d="M6.8 12.8C7.8 11 9.2 10 10.8 10c.9 0 1.7.3 2.6 1 .7.6 1.4 1.5 2.1 2.8l.4.7c-.6 1-1.1 1.8-1.5 2.4l-.5-.9c-.6-1.1-1.1-1.8-1.5-2.2-.5-.5-1-.7-1.5-.7-.7 0-1.3.4-1.8 1.1-.3.5-.6 1.1-.7 1.8l-2.3-1c.2-.8.6-1.6 1.2-2.2z"
            fill="white"
          />
        </svg>
      );
