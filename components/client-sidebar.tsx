...
const NAV_ITEMS = [
  ...
  { label: "My Accounts", href: "/portal/accounts", icon: Monitor },
  { label: "Transactions", href: "/portal/transactions", icon: ArrowLeftRight },
  { label: "Top Ups", href: "/portal/topups", icon: TrendingUp },
] as const;
...
export function ClientSidebar({ userName, clientCode }: Props) {
      ...
      <div className="border-t border-[hsl(222,47%,17%)] px-4 py-4">
        <div className="mb-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs font-mono text-[hsl(215,20%,65%)]">{clientCode}</p>
          </div>
        </div>
        <button
